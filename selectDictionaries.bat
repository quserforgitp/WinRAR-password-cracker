...
SET FILE=
CLS
SET /P FILE="DRAG 'N DROP THE RAR FILE HERE OR ENTER THE ENTIRE PATH --> "
ECHO %FILE%
IF [%FILE%] EQU [] (ECHO WE NEED THE FILE'S PATH TO MAKE THE ATTACK&&ECHO [92mPRESS ANY KEY TO CONTINUE[0	m&&PAUSE>NUL &&GOTO GETFILE)
